    ...
    useQuery(
        ...
        `,
        {
            onCompleted: (data) => {
                ...
                const refinedDataByDate = tempPNL
                    .reduce((mapByDate: any, nextEpoch: any) => {
                        ...
                        mapByDate[dateLocale] = {
                            ...
                            pnl: nextEpoch.timestamp > dateGroup.timestamp ?
                                nextEpoch.pnl : dateGroup.pnl,
                            // Sum share deposits
                            shares:
                                BigNumber.from(nextEpoch.shares).add(BigNumber.from(dateGroup.shares)).toString(),
                ...
                Object.keys(refinedDataByDate).length > 0 && setHistoricalPNL(Object.values(refinedDataByDate));
